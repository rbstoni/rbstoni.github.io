...
namespace Rtrw.Client.Wasm.Components.Extensions
{
    public static class EditContextFluentValidationExtensions
    {
        ...
        public static void AddFluentValidation(this EditContext editContext, IServiceProvider serviceProvider, bool disableAssemblyScanning, IValidator? validator, RtrwFluentValidationValidator fluentValidationValidator)
        {
        ...
        private static async Task ValidateModel(EditContext editContext,
            ...
            RtrwFluentValidationValidator fluentValidationValidator,
